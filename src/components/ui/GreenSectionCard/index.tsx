...
interface GreenSectionCardProps {
  section: SectionData;
}

export default function GreenSectionCard({ section }: GreenSectionCardProps) {
        ...
        >
          ...
          {sections.map((letter, i) => (
            <text
              ...
              className={
                i === activeSectionIndex ? styles.label_active : styles.label
              }
            >
              {letter}
            </text>
